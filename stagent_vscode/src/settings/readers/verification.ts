...
export function readVerificationFlakyRerunCount(cfg?: vscode.WorkspaceConfiguration): number {
...
export function readVerificationDeterministic(cfg?: vscode.WorkspaceConfiguration): boolean {
