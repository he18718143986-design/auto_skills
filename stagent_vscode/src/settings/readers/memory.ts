...
export function readMemoryExperienceStoreEnabled(cfg?: vscode.WorkspaceConfiguration): boolean {
  return readConfigBooleanDefaultTrue(cfg, 'memory.enableExperienceStore');
}

/** vscode `stagent.memory.maxExperienceEntries` */
export function readMemoryMaxExperienceEntries(cfg?: vscode.WorkspaceConfiguration): number {
...
export function readCodebaseContextEnabled(cfg?: vscode.WorkspaceConfiguration): boolean {
  return readConfigBooleanDefaultTrue(cfg, 'codebaseContext.enabled');
}

/** vscode `stagent.codebaseContext.maxTokens` */
export function readCodebaseContextMaxTokens(cfg?: vscode.WorkspaceConfiguration): number {
  return readConfigResolved(
    cfg,
...
export function readExperienceInjectOnGenerate(cfg?: vscode.WorkspaceConfiguration): boolean {
...
export function readPromptVersionsEnabled(cfg?: vscode.WorkspaceConfiguration): boolean {
