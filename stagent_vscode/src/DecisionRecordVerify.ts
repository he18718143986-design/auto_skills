...
import { decisionLintMsg } from './l10n/lintMsg';
  ...
  if (missingSections.length > 0) {
    for (const label of missingSections) {
      violations.push({
        ...
        invariantId: 'I-17',
        message: decisionLintMsg('missing-section', label),
  ...
  if (stressBody !== null) {
    ...
    if (n < 2) {
      violations.push({
        ...
        invariantId: 'I-18',
        message: decisionLintMsg('insufficient-stress-tests', String(n)),
  ...
  if (assumpBody !== null) {
    ...
    if (n < 1) {
      violations.push({
        ...
        invariantId: 'I-19',
        message: decisionLintMsg('insufficient-assumptions', String(n)),
