...
import { isVscodeCancellationError } from '../adapters/vscodeCancellation';
...
> {
  ...
  return {
    ...
    warn: e.warn ? (message) => e.warn!(message) : undefined,
    ...
    isCancellationError: (error) => isVscodeCancellationError(error),
  };
}
