import { ArtifactLifecycleManager, type SamePathConflictHandler } from './ArtifactLifecycleManager';
...
export function trackPersistedFileForInstance(
  ...
  ensureArtifactRegistryForInstance(instance).trackPersistedFile(input, onSamePathConflict);
}
