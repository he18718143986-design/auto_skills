...
export function workflowGenRepairLlmInvokeOpts(): LlmInvokeOpts {
  return { requireStructured: true, jsonMode: true };
}

/** workflow-gen-continue：续写片段，非完整 JSON object。 */
export function workflowGenContinueLlmInvokeOpts(): LlmInvokeOpts {
  return { requireStructured: true };
}
