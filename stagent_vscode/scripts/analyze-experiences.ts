...
import { experiencesPath } from '../src/paths/StagentPaths';
import { EXPERIENCES_FILENAME, WorkflowExperienceStore } from '../src/WorkflowExperienceStore';
import {
...
function main(): void {
  ...
  const storePath = experiencesPath(workspace, EXPERIENCES_FILENAME);
